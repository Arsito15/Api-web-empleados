<%-- 
    Document   : index
    Created on : 23 oct 2022, 8:27:22
    Author     : Arun Solis
--%>
    ...
    <body>
        ...
        <section class="inicio" id="inicio">
            ...
            <div class="content">
                ...
                <p>Formulario control de los agentes activos a la institución. Objetivo: tener un control y organizacion de un grupo especifico.</p>
